              ...
              <div  class="row">
                ...
                <div class="row">
                    ...
                    <div style="padding:10px;" class="col s12">
                        ...
                        <h1 class="center-align">Welcome to Quick Scthocks</h1>
                ...
                <div  class="row center-align">
                    ...
                    <div id="action-load" class="col s12">

                      <a id="action-button" style="width:75%; height: auto;" class="waves-effect waves-light btn button center">Get A Quote Now</a>
                         <!--<iframe class="" width="100%" height="100px" src="action-button-toolbar.html" frameborder="0"></iframe>
                         -->
